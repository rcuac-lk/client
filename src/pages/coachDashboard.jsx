...
const Dashboard = ({ userDetails }) => {
  return (
    <div className="p-4 rounded-lg bg-gray-800">
      <h2 className="text-xl font-bold text-white mb-4">Welcome, Coach {userDetails.firstName} {userDetails.lastName}!</h2>
      <p className="text-gray-400">This is your coach dashboard. You can manage your students, track attendance, and record timing.</p>
      
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mt-4">
        <div className="p-4 rounded-lg bg-gray-700">
          <h3 className="text-lg font-semibold text-white mb-2">Quick Actions</h3>
          <ul className="text-gray-400">
            <li className="mb-1">• Take attendance</li>
            <li className="mb-1">• Record timing</li>
            <li className="mb-1">• View students</li>
          </ul>
        </div>
        <div className="p-4 rounded-lg bg-gray-700">
